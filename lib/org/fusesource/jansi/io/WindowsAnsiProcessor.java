 ...
 */
package lib.org.fusesource.jansi.io;

import static lib.org.fusesource.jansi.internal.Kernel32.BACKGROUND_BLUE;
import static lib.org.fusesource.jansi.internal.Kernel32.BACKGROUND_GREEN;
import static lib.org.fusesource.jansi.internal.Kernel32.BACKGROUND_INTENSITY;
import static lib.org.fusesource.jansi.internal.Kernel32.BACKGROUND_RED;
import static lib.org.fusesource.jansi.internal.Kernel32.CHAR_INFO;
import static lib.org.fusesource.jansi.internal.Kernel32.FOREGROUND_BLUE;
import static lib.org.fusesource.jansi.internal.Kernel32.FOREGROUND_GREEN;
import static lib.org.fusesource.jansi.internal.Kernel32.FOREGROUND_INTENSITY;
import static lib.org.fusesource.jansi.internal.Kernel32.FOREGROUND_RED;
import static lib.org.fusesource.jansi.internal.Kernel32.FillConsoleOutputAttribute;
import static lib.org.fusesource.jansi.internal.Kernel32.FillConsoleOutputCharacterW;
import static lib.org.fusesource.jansi.internal.Kernel32.GetConsoleScreenBufferInfo;
import static lib.org.fusesource.jansi.internal.Kernel32.GetStdHandle;
import static lib.org.fusesource.jansi.internal.Kernel32.SMALL_RECT;
import static lib.org.fusesource.jansi.internal.Kernel32.STD_OUTPUT_HANDLE;
import static lib.org.fusesource.jansi.internal.Kernel32.STD_ERROR_HANDLE;
import static lib.org.fusesource.jansi.internal.Kernel32.ScrollConsoleScreenBuffer;
import static lib.org.fusesource.jansi.internal.Kernel32.SetConsoleCursorPosition;
import static lib.org.fusesource.jansi.internal.Kernel32.SetConsoleTextAttribute;
import static lib.org.fusesource.jansi.internal.Kernel32.SetConsoleTitle;

import java.io.IOException;
import java.io.OutputStream;

import lib.org.fusesource.jansi.internal.Kernel32.CONSOLE_SCREEN_BUFFER_INFO;
import lib.org.fusesource.jansi.internal.Kernel32.COORD;
import lib.org.fusesource.jansi.WindowsSupport;
